...
const LightPillar = ({
  ...
  quality = 'high',
  lightMode = false,
  // Escala de render independiente de `quality`. `quality` empaqueta
  // resolución CON número de iteraciones, y bajarlo cambia la FORMA del haz
  // (menos iteraciones de onda = menos filamentos). Esto permite rebajar solo
  // los píxeles —invisible en un degradado difuminado, pero cuadrático en
  // coste— manteniendo el aspecto exacto.
  renderScale = null
}) => {
  ...
  }, [webGLSupported, quality, renderScale]);
